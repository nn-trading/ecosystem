...
Set-Content -Encoding Ascii -LiteralPath 'reports\AUTOFIX_OK.txt' -Value "[$ts] AUTOFIX: config ok, deps ok, background ok, chat launched=$($LaunchChat.IsPresent)"
